...
CRON_CONFIG_FILE="${CRON_CONFIG_FILE:-/etc/enderd/cron/crontab}"
CRON_LOG_FILE="${CRON_LOG_FILE:-/etc/enderd/logs/cron.log}"
CRON_PID_FILE="${CRON_PID_FILE:-/etc/enderd/tmp/cron.pid}"
CRON_ENGINE="/etc/enderd/modules/cron/cron-engine.sh"
