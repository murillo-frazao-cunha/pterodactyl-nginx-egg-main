...
PHP_INI="${PHP_INI:-/etc/enderd/php/php.ini}"
PHP_FPM_CONF="${PHP_FPM_CONF:-/etc/enderd/php/php-fpm.conf}"
NGINX_CONF="${NGINX_CONF:-/etc/enderd/nginx/nginx.conf}"
NGINX_PREFIX="${NGINX_PREFIX:-/etc/enderd}"
